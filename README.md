...
[![Skills: 40](https://img.shields.io/badge/skills-40-1f6feb.svg?style=flat-square)](./skills/README.md)
...
|---|---|
| 40 skills (planning, readiness, evidence, handoff, troubleshooting, brainstorming, web 3D handoff deep, quality validation deep, domain scene planners, process discipline, asset/sourcing, color/format/output decisions, …) | **Path 1 — Blender Lab MCP** (Lab add-on + Lab server). Owner: Blender Foundation. Source: [blender.org/lab/mcp-server](https://www.blender.org/lab/mcp-server/) |
...
- The **skills layer** (40 skills + workflows + install docs + ZIP generation + CI guards) is **complete** at Draft v0 — nothing upstream blocks it. Roadmap target: 48 skills (3x); progress 40/48 (Batches 5+6 added; v0.4.0-draft milestone tag pending operator).
