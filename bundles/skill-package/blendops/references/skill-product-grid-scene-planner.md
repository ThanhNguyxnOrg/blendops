...
Output contract: structured plan with Product list / Grid layout / Consistency level / Shared lighting / Shared background / Per-cell camera / Caption space sections, asset list flagged, evidence label.
